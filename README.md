![Laravel Crud Generator](https://banners.beyondco.de/Laravel%20CRUD.png?theme=dark&packageManager=composer+require&packageName=pirulug%2Fcrud-generator&pattern=polkaDots&style=style_2&description=Laravel+CRUD+generator&md=1&showWatermark=0&fontSize=125px&images=https%3A%2F%2Flaravel.com%2Fimg%2Flogomark.min.svg)
...
1 - Install
```
composer require pirulug/crud-generator --dev
```
...
```
composer require pirulug/crud-generator:1.6 --dev
```
